 ...
 * @author dungn
 */
public class LopXe_JFrame extends javax.swing.JFrame {

    private DefaultTableModel model = new DefaultTableModel();
    private LopXe_repository res = new LopXe_repository();
    private int index = -1;

    /**
     * Creates new form LopXe_JFrame
     */
    public LopXe_JFrame() {
        initComponents();
        this.setLocationRelativeTo(null);
        setTitle("Lốp Xe");
        this.Fill(res.getAllLX());
    }

    void Fill(List<Model_LopXe> list) {
        model = (DefaultTableModel) tbl.getModel();
        model.setRowCount(0);
        sortSTTColumn();
        for (Model_LopXe s : list) {
    ...
    Model_LopXe read() {
        Model_LopXe gd = new Model_LopXe();
        gd.setMaLX(txtMa.getText().trim());
        gd.setTenLX(txtTen.getText().trim());
        return gd;
    }
    ...
    private void btnADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnADDActionPerformed
        Model_LopXe gd = read();
        LopXe_repository repoGX = new LopXe_repository();
        if (repoGX.InsertLX(gd) > 0) {
            JOptionPane.showMessageDialog(this, "Thêm thành công");
            Fill(repoGX.getAllLX());
            this.clear();
        } else {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            Model_LopXe gd = read();
            LopXe_repository repoGX = new LopXe_repository();
            if (repoGX.updateLopXeByMaGD(gd) > 0) {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            ...
            if (repo.deleteLopXeById(maGD) > 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LopXe_JFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
