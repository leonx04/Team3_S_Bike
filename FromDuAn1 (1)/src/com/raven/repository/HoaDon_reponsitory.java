...
import com.raven.connectDB.DBConnect;
import com.raven.event.HoaDonInteface;
...
//    public List<Model_SanPham> getAllHoaDonChiTiet(String ma) {
...
//            rs = ps.executeQuery();
//            while (rs.next()) {
//                Model_SanPham sp = new Model_SanPham(rs.getString(1), rs.getString(2), rs.getInt(3), rs.getInt(4));
//                list.add(sp);
//            }
//            rs.close();
//        } catch (Exception e) {
...
//    public List<Model_SanPham> getSanPham(String ma) {
//        List<Model_SanPham> list = new ArrayList<>();
//        try {
