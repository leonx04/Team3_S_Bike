 ...
 * @author dungn
 */
public class GhiDong_JFrame extends javax.swing.JFrame {

    /**
     * Creates new form GhiDong_JFrame
     */
    private DefaultTableModel model = new DefaultTableModel();
    private GhiDong_repository res = new GhiDong_repository();
    private int index = -1;

    public GhiDong_JFrame() {
        initComponents();
        this.setLocationRelativeTo(null);
        setTitle("Ghi Đông");
        this.Fill(res.getAllGD());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GhiDong_JFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
